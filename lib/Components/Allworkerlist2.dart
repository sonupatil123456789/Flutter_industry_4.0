  ...
  Future Getallworkersdetails() async {
    ...
    try {
      final response = await http.get(Uri.parse(
          'http://$baseurl/api/v1/contracteraccountworkers/$companyid'));
    ...
    return Scaffold(
      ...
      child: Container(
          ...
          child: Column(children: [
            const Back_btn_navbar(navname: "All worker details"),
            SizedBox(
              height: 20,
            ),
            Expanded(
                                      ...
                                      Navigator.push(context,
                                        ...
                                        return Updateworkerform(
                                          ...
                                          workernumberparams:
                                              mapresponsedata[index]
                                                  ["workernumber"],
                                          imagesparams: mapresponsedata[index]
                                              ["images"],
                                          birthdateparams:
                                              mapresponsedata[index]
                                                  ["birthdate"],
                                          addressparams: mapresponsedata[index]
                                              ["address"],
                                          adharnumberparams:
                                              mapresponsedata[index]
                                                  ["adharnumber"],
                                          ...
                                          bloodgroupparams:
                                              mapresponsedata[index]
                                                      ["medicalinformation"]
                                                  ["bloodgroup"],
                                          companyid: mapresponsedata[index]
                                              ["companyid"],
                                        );
                                      }));
                                    },
